...
# def subject_cart(name, code, section, stats=None, footer_callback=None):
#     html = f""" 
#         <div style='background:white; border-left:8px solid #EB459E; padding:25px; border-redius: 20px; border: 1px solid black; margin-botton:20px'>
#         <h3 style="marrgin:0; color: #1e293b; font-size: 1.5rem "> (name) </h3>
